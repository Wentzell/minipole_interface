...
from minipole_interface import __version__
...
html_context = {'header_title': 'minipole_interface'}

html_static_path = [os.path.join(_HERE, '_static')]
html_sidebars = {'index': ['sideb.html', 'searchbox.html']}

htmlhelp_basename = 'minipole_interfacedoc'
